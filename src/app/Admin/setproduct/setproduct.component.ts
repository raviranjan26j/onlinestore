...
export class SetproductComponent implements OnInit,OnDestroy  {
 ...
 @ViewChild(MatSort, {static: false}) sort: MatSort;
  ...
  getDoc(docId){
    this.dataLoading=false;
    this.querySubscription=this._backendservice.getOneProductsDoc('product',docId)
    .subscribe(res=>{
      if(res){
        this.myDocData=res;
  ...
  deleteDoc(docId){
    ...
    this.dataLoading=true;
    this.querySubscription=this._backendservice.delOneProductsDoc('product',docId)
    .subscribe(res=>{
      if(res){
